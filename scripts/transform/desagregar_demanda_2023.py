...
# Desagrega Historico(s)_Ventas_2023.csv aplicando el calendario estacional 2023.
# Guarda la salida en data/processed/demanda_diaria_2023.csv
...
def _pick_existing(paths):
    for p in paths:
        if p.exists():
            return p
    raise FileNotFoundError("No se encontró el histórico 2023. Probados:\n  - " + "\n  - ".join(map(str, paths)))
